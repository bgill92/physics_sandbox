...
// A concept which constrains the class to have a setZero() function
template <typename T>
...
/**
 * @brief      Performs RK4 integration
 *
 * @param[in]  value            The value at which to perform the integration
 * @param[in]  timestep         The timestep to perform the integration over
 * @param[in]  derivative_func  A function which calculates the derivative at a given value
 *
 * @tparam     T                A class that can be zerod
 *
 * @return     How much the value incremented
 */
template <zeroable T>
